...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyProject.Core.Entities.Common.EntityCustomFields", b =>
                {
            ...
            modelBuilder.Entity("MyProject.Core.Entities.Configuration.Permission", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MyProject.Core.Entities.Content.Category", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MyProject.Core.Entities.Content.EntityTag", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MyProject.Core.Entities.Content.Reaction", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MyProject.Core.Entities.Configuration.Setting", b =>
                {
                    b.HasOne("MyProject.Core.Entities.Common.EntityCustomFields", "CustomFields")
                        .WithMany()
            ...
            modelBuilder.Entity("MyProject.Core.Entities.Content.EntityTag", b =>
                {
                    b.HasOne("MyProject.Core.Entities.Content.Activity", null)
                        .WithMany("Tags")
                        .HasForeignKey("ActivityId");

                    b.HasOne("MyProject.Core.Entities.Organization.Badge", null)
                        .WithMany("Tags")
                        .HasForeignKey("BadgeId");

                    b.HasOne("MyProject.Core.Entities.Content.Category", null)
                        .WithMany("Tags")
                        .HasForeignKey("CategoryId");

                    b.HasOne("MyProject.Core.Entities.Organization.Group", null)
                        .WithMany("Tags")
                        .HasForeignKey("GroupId");

                    b.HasOne("MyProject.Core.Entities.Organization.GroupMember", null)
                        .WithMany("Tags")
                        .HasForeignKey("GroupMemberId");

                    b.HasOne("MyProject.Core.Entities.Organization.Invitation", null)
                        .WithMany("Tags")
                        .HasForeignKey("InvitationId");

                    b.HasOne("MyProject.Core.Entities.Content.Message", null)
                        .WithMany("Tags")
                        .HasForeignKey("MessageId");

                    b.HasOne("MyProject.Core.Entities.Content.NodeVote", null)
                        .WithMany("Tags")
                        .HasForeignKey("NodeVoteId");

                    b.HasOne("MyProject.Core.Entities.Content.Reaction", null)
                        .WithMany("Tags")
                        .HasForeignKey("ReactionId");

                    b.HasOne("MyProject.Core.Entities.Configuration.Setting", null)
                        .WithMany("Tags")
                        .HasForeignKey("SettingId");

                    b.HasOne("MyProject.Core.Entities.Organization.Site", null)
                        .WithMany("Tags")
